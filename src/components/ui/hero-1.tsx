    ...
    <section className="mx-auto w-full max-w-5xl">
      ...
      <div className="relative flex flex-col items-center justify-center gap-5 pt-24 pb-20">
        ...
        >
          ...
          <span className="text-xs">Nieuwe website live!</span>
        ...
        <p className="fade-in slide-in-from-bottom-10 mx-auto max-w-md animate-in fill-mode-backwards text-center text-base tracking-wider text-foreground/80 delay-200 duration-500 ease-out sm:text-lg md:text-xl">
          We koppelen je aan talent en tools zodat je sneller kunt schalen,
          innoveren en leiden.
        </p>
        ...
        <div className="fade-in slide-in-from-bottom-10 flex animate-in flex-row flex-wrap items-center justify-center gap-3 fill-mode-backwards pt-2 delay-300 duration-500 ease-out">
          <Button className="rounded-full" size="lg" variant="secondary" asChild>
            <a href="/contact">
              <PhoneCallIcon className="mr-2 size-4" /> Plan een gesprek
            </a>
          </Button>
  ...
  return (
    <section className="relative space-y-4 border-t pt-6 pb-10">
      <h2 className="text-center text-lg font-medium tracking-tight text-muted-foreground md:text-xl">
        Vertrouwd door <span className="text-foreground">experts</span>
      </h2>
